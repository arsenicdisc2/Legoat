...
(() => {
  var e = { 286(e2, t2, r2) {
    ...
    let o2 = "0.0.14";
    function s() {
      if ("undefined" == typeof _u7zb862) throw Error("_w29jwju9ewdu_w29jwju9ewd is not loaded. Load _x6rxkrw before the controller.");
      var e3 = "2.0.67-alpha.2", t3 = _u7zb862.versionInfo.version;
      if (e3 !== t3) throw Error(`_w29jwju9ewdu_w29jwju9ewd version mismatch: this build expects ${e3}, but the loaded runtime is ${t3}`);
    }
  }, 805(e2, t2, r2) {
    r2.d(t2, { C: () => o2 });
    class o2 {
  ...
  (() => {
    ...
    let c = { prefix: "/~/sj/", _x6rxkrwPath: "/_x6rxkrw/_x6rxkrw.js", injectPath: "./controller/controller.inject.js", wasmPath: "/_x6rxkrw/_x6rxkrw.wasm", virtualWasmPath: "_x6rxkrw.wasm.js", codec: { encode: (e3) => e3 ? encodeURIComponent(e3) : e3, decode: (e3) => e3 ? decodeURIComponent(e3) : e3 } }, l = { flags: { ...i.sb.flags, allowFailedIntercepts: true }, maskedfiles: ["inject.js", "_x6rxkrw.wasm.js"] };
    ...
    function g() {
      return p || (p = new Promise((e3, t3) => {
        let r2 = indexedDB.open("__clmfl8ly3j7_6clmfl8", 1);
        r2.onupgradeneeded = () => {
          let e4 = r2.result;
    ...
    class S {
      ...
      cookieSyncChannel = new BroadcastChannel("__wy2j9qrfu91_kwy2j9qrfu91_kw");
      ...
      constructor(t3) {
        this.init = t3, (0, a.O)(), this.id = b(), this.config = j(c, t3.config || {}), this._x6rxkrwConfig = j(l, i.sb), this._x6rxkrwConfig = j(this._x6rxkrwConfig, t3._x6rxkrwConfig || {}), this.prefix = this.config.prefix + this.id + "/", this.serviceWorkerController = t3.serviceworker, this.ready = Promise.all([new Promise((e3) => {
    ...
    class v {
      ...
      hooks;
      get context() {
        return { config: this.controller._x6rxkrwConfig, prefix: new URL(this.prefix, location.href), cookieJar: this.controller.cookieJar, interface: { getInjectScripts: /* @__PURE__ */ (function e3(t3, r2, o2, s2, i2, n2) {
          return (a2, c2, l2, d2) => {
            var h2;
            return [d2(t3._x6rxkrwPath), d2(o2.href + t3.virtualWasmPath), d2(t3.injectPath), d2("data:text/javascript;charset=utf-8;base64," + (h2 = `
					document.querySelectorAll("script[_xmuo6vh89r5w_xmu]").forEach(script => script.remove());
					_5ds99mk.load({
        ...
        })(this.controller.config, this.controller._x6rxkrwConfig, new URL(this.prefix, location.href), this.controller.cookieJar, this.controller.config.codec.encode, this.controller.config.codec.decode), getWorkerInjectScripts: (e3, t3, r2) => {
          var o2;
          let s2 = "";
          return s2 += r2(this.controller.config._x6rxkrwPath), s2 += r2(this.prefix + this.controller.config.virtualWasmPath), s2 += r2("data:text/javascript;charset=utf-8;base64," + (o2 = `
					(()=>{
						const { _k4dorc7kfvt2_, CookieJar, setWasm } = _u7zb862;

						setWasm(Uint8Array.from(atob(self.WASM), (c) => c.charCodeAt(0)));
						delete self.WASM;

						const sjconfig = ${JSON.stringify(this.controller._x6rxkrwConfig)};
						...
						const client = new _k4dorc7kfvt2_(globalThis, {
							context,
							transport: null,
						});
